...
datos %>%
  ...
  geom_line() +
  #facet_grid(~anno)+
  scale_color_manual(values = grDevices::colorRampPalette(RColorBrewer::brewer.pal(8, "Dark2"))(255)) +
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5)) +
  scale_x_continuous(breaks=seq(0, 10, 1))+
  ylab("Tasas promedio") +
...
Al ver todas las 254 curvas juntas se aprecia que hay mucha variación pues al inicio hay fluctuaciones, antes del año, y luego hay mucha variabilidad en las tasas según el año en que se estimaron principalmente.
