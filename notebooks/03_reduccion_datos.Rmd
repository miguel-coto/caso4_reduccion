...
grid()
```
Según el gráfico de sedimentación se podrían sugerir 2 o 3 componentes.
...
las cargas del primer componente principal son todas positivas y similares entre sí. En
nuestro caso este factor explica un 92.7%, de la variabilidad total, siendo claramente el más importante. El primer factor es casi plano.
...
saveRDS(comp, file = paste0(processed_data, "/componentes.Rds"))
